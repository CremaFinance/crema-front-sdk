...
async function main() {
    ...
    let program_id = new PublicKey("8vd36jeJ3R29TwQetKrwrv174PscM4NL5HFrrNxHgN3R")
    let tokenAMint = new PublicKey("Gcu9zjxrjez4xWGj8bi2gTLXYN8hD8Avu2tN8xfnV65Q")
    let tokenBMint = new PublicKey("GHStiPQDe4HEQxtDzyFFuNjP6Z6GqYhbPqJ6oiRFmGWT")
